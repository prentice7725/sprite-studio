...
from sprite_studio.spec.layout import frames_dir_rel, raw_rel, state_frame_total
from sprite_studio.spec.runio import (acquire_run_dir_lock, atomic_write_text, load_request,
                              read_guard, relative_posix)
from sprite_studio.frames.segment import segment_strip
...
def _inspect_run_impl(run_dir: Path, states: str = "all", **kwargs: object) -> dict[str, Any]:
    ...
    return {
        ...
        "kind": "sprite-studio-inspect-report",
        "run_dir": str(run_dir),
        "states": selected,
        "thresholds": {
