...
const STR = {
  en: {
    ...
    tRcSection: "colour variants baked by `sprite-studio recolor` into <run-dir>/variants — the sheets are what the runtime loads, so what you compare here is what ships",
  ...
  ko: {
    ...
    tRcSection: "`sprite-studio recolor` 가 <run-dir>/variants 에 구운 색 변형 시트 — 런타임이 읽는 파일 그 자체라, 여기서 비교하는 것이 곧 출시본입니다",
