...
`sprite_studio.gen` owns the optional transparent chroma post-process and the
...
GEN_TIMEOUT_SECONDS = int(os.environ.get("SPRITE_STUDIO_GEN_TIMEOUT_SECONDS", "180"))
...
@dataclass
class GenResult:
    """Full outcome of one `sprite-studio gen` invocation."""
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "kind": "sprite-studio-image-report",
