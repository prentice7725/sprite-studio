...
부른 명령 안에서만 일어난다 (plan sprite-studio/state-revision-read-mutation).
...
from sprite_studio.curate.curation import CURATION_FILENAME, run_revision
from sprite_studio.spec.runio import LEGACY_FIT_KEYS, REQUEST_FILENAME, migrate_request_file
