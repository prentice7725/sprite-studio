...
from sprite_studio.effects.breathe import anatomy_report, fit_breathe_pattern, phase_frame, resolve_anatomy
from sprite_studio.curate.curation import apply_pixel_edits, apply_transform, edit_index, frame_variant, load_curation, pixel_snap_scale, source_frame_index, state_breathe, state_pixel_ops, state_plan
...
from sprite_studio.compose.layers import (has_layer_contract, landmark_map, require_valid_layer_request,
                               state_track)
from sprite_studio.spec.runio import acquire_run_dir_lock, atomic_save_image, atomic_write_text, load_request
from sprite_studio.spec.subject import default_min_used_pixels
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # (sprite_studio.spec.subject); the flag is an explicit override only.
