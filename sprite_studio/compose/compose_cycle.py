...
from sprite_studio.curate.curation import apply_pixel_edits, apply_transform, frame_variant, load_curation, pixel_snap_scale, source_frame_index, state_pixel_ops, state_plan
...
from sprite_studio.util.gif_utils import delay_ticks_to_duration_ms, save_clean_gif
from sprite_studio.spec.runio import read_guard, relative_posix, load_request
...
def _run_guarded(args, run_dir):
    ...
    manifest = {
        "version": 1,
        "kind": "sprite-studio-selected-cycle",
        "run_dir": str(run_dir),
        "state": args.state,
        "name": args.name,
