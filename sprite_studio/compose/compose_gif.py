...
from sprite_studio.effects.breathe import anatomy_report, bake_breathe_sequence
...
from sprite_studio.frames.extract import require_frames_manifest
from sprite_studio.spec.runio import read_guard, load_request
from sprite_studio.util.gif_utils import delay_ticks_to_duration_ms, gif_report, save_clean_gif
...
def _run_dir_mode_guarded(args, run_dir):
    ...
    manifest = {"version": 1, "kind": "sprite-studio-gif-run", "run_dir": str(run_dir), "exports": exports}
