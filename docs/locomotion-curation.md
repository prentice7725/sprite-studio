# Locomotion Curation & Clean GIF Export — sprite-studio reference
...
```bash
$SPRITE_STUDIO_ROOT/.venv/bin/python $SPRITE_STUDIO_ROOT/scripts/compose_selected_cycle.py \
...
```bash
$SPRITE_STUDIO_ROOT/.venv/bin/python $SPRITE_STUDIO_ROOT/scripts/compose_sprite_gif.py \
