...
loudly rather than silently take a slower route. `sprite_studio/_deps.py` is the
single module that imports NumPy and is imported by `sprite_studio/__init__.py`, so
