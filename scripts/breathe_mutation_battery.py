...
MUTS = [
    ...
    ("N5 탈출 D: let + 재대입", "sprite_studio/serve/curator/src/cards.js",
     "        const canonical = canonSrc ? img(canonSrc) : null;\n        if (!(canonical && canonical.complete && canonical.naturalWidth)) {",
    ...
    ("N5 탈출 E: ctx 리네임 + 폴백 복원", [
        ("sprite_studio/serve/curator/src/cards.js",
    ...
    ("N5 탈출 I: || 폴백을 img 인자 안에", [
        ("sprite_studio/serve/curator/src/zoom-editor.js", '      const canonImg = refUrl ? img(refUrl) : null;',
    ...
    ("N5 탈출 J: 줄바꿈으로 분기 숨기기", [
        ("sprite_studio/serve/curator/src/cards.js", '        const canonical = canonSrc ? img(canonSrc) : null;\n        if (!(canonical && canonical.complete && canonical.naturalWidth)) {',
         "        const canonImg = canonSrc ? img(canonSrc) : null;\n"
    ...
    ("N5 탈출 K: 줄바꿈으로 프리뷰 사이트 증발 + 기준 인자 제거", [
        ("sprite_studio/serve/curator/src/zoom-editor.js", '      bctx.drawImage(bm.enabled ? breatheComposeForPreview(base, bm.cfg, phase, breatheRef()) : base, 0, 0);',
    ...
    ("N5 탈출 L: 내보내기 플러밍을 공용 헬퍼로 + 게이트 제거", [
        ...
        ("sprite_studio/serve/curator/src/util.js",
        ...
        ("sprite_studio/serve/curator/src/compare.js",
