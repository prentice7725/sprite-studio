...
def test_recolor_leaf_doc_exists_and_teaches_both_commands() -> None:
    ...
    assert "sprite-studio recolor" in text
    assert "sprite-studio recolor-palette" in text
    assert "sprite-studio-recolor" in text  # spec kind
    assert "sprite-studio-recolor-report" in text  # report kind
...
RECOLOR_SURFACE = (
    "docs/recolor.md",
    "scripts/recolor.py",
    "sprite_studio/effects/recolor.py",
    "sprite_studio/serve/curator/src/recolor.js",
