...
(`sprite_studio/serve/curator/src/breathe.js`). 검출은 서버 한 곳으로 몰았지만 워프는 프리뷰를
...
from sprite_studio.effects.breathe import (MAX_ROW_STRAIN, anatomy_fingerprint,  # noqa: E402
                                freeze_anatomy, phase_frame, reference_key, resolve_anatomy,
                                row_strain)
from sprite_studio.frames.extract import solid_alpha_bbox  # noqa: E402
