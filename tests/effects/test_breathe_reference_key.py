...
from sprite_studio.effects.breathe import anatomy_fingerprint, reference_key  # noqa: E402
from sprite_studio.serve.serve_curation import CURATOR_DIR  # noqa: E402
...
def test_the_key_never_reads_pixels():
    ...
    from sprite_studio.effects import breathe
...
def web_run_plain(web_run):
    ...
    from sprite_studio.curate.curation import empty_curation
...
def test_a_rotated_row_stays_fresh(web_run_plain):
    ...
    import sprite_studio.serve.serve_curation as serve_curation
    from sprite_studio.effects.breathe import freeze_anatomy
...
def test_the_webview_resolves_the_bake_variant_like_the_server(twin, own, wide):
    ...
    → 변종 이름) 세 번 되돌아왔다."""
    from sprite_studio.curate.curation import frame_variant
...
def test_normalize_transform_mirror_agrees_on_the_full_product():
    ...
    from sprite_studio.curate.curation import normalize_transform
...
def test_edit_index_mirror_agrees_on_the_full_product():
    ...
    않았고 교차언어 테스트도 없었다."""
    from sprite_studio.curate.curation import edit_index
...
def test_the_mirrored_limits_are_the_same_numbers():
    ...
    설정을 만들 수 있다."""
    from sprite_studio.curate import curation as C
