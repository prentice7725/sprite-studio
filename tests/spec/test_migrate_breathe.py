...
from sprite_studio.curate.curation import RETIRED_BREATHE_KEYS, state_breathe  # noqa: E402
from sprite_studio.spec.migrate_breathe import migrate_entry, run  # noqa: E402


def _sidecar(tmp_path, breathe):
    data = {"version": 1, "kind": "sprite-studio-curation",
...
def test_a_non_integer_breaths_is_reported_not_truncated() -> None:
    ...
    "무엇을 버렸는지 전부 출력한다" 다."""
    from sprite_studio.spec.migrate_breathe import migrate_entry
