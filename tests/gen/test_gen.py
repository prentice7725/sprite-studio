...
from sprite_studio.gen import base as gen_base
from sprite_studio.gen import chroma as chroma_mod
from sprite_studio.gen import codex_provider
from sprite_studio.gen.base import GenRequest
...
def test_grok_prompt_switches_on_refs(tmp_path: Path) -> None:
    from sprite_studio.gen import grok_provider
...
# fallback when codex is unavailable, SPRITE_STUDIO_DEFAULT_PROVIDER override. ──────
