...
sprite_studio.compose.compose_layers`, and the `scripts/` wrapper the SKILL.md script map
...
from sprite_studio import cli
from sprite_studio.compose import compose_layers
...
def test_compose_layers_launch_forms_expose_the_same_flags() -> None:
    subcommand = _help_options("-m", "sprite_studio.cli", "compose-layers")
    module = _help_options("-m", "sprite_studio.compose.compose_layers")
