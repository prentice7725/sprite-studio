...
sprite-studio/extract-performance).
...
original float reduction (plan `sprite-studio/best-phase-hotspot`, 2026-07-25).
...
def test_grid_uniformity_matches_the_exact_rational_value():
    ...
    reduction" (plan `sprite-studio/best-phase-hotspot`, 2026-07-25). The old form
