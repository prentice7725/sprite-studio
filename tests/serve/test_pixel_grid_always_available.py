...
SERVE = (ROOT / "sprite_studio" / "serve" / "serve_curation.py").read_text(encoding="utf-8")


def _pitch(path):
    from sprite_studio.serve.serve_curation import detect_pixel_pitch  # noqa: PLC0415
