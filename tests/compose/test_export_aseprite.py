...
from sprite_studio.compose import export_aseprite
from sprite_studio.compose.export_aseprite import aseprite_json, split_state_jsons
...
def test_real_composed_run_exports_phaser_and_flame_shapes(fixture_run_dir: Path) -> None:
    ...
    command = [sys.executable, "-m", "sprite_studio.cli", "export-aseprite", "--run-dir", str(fixture_run_dir)]
