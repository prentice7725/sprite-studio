...
from sprite_studio.curate import anchor as anchor_mod  # noqa: E402
from sprite_studio.frames import extract as extract_module  # noqa: E402
from sprite_studio.curate.curation import (anchor_choices, load_curation, state_instances,  # noqa: E402
...
def _save_curation(run_dir: Path, states: dict, anchors: dict | None = None) -> None:
    payload = {"version": 1, "kind": "sprite-studio-curation", "states": states}
...
def _cli(run_dir: Path, *args: str):
    ...
    return subprocess.run([sys.executable, "-m", "sprite_studio.cli", "anchor",
...
def test_cli_pick_does_not_resurrect_dropped_curation(direction_run: Path) -> None:
    from sprite_studio.curate.curation import load_curation_report
...
def _post_curation(run_dir: Path, body: dict) -> int:
    ...
    try:
        ...
        payload = {"version": 1, "kind": "sprite-studio-curation",
...
def test_reroll_identity_ref_uses_the_picked_anchor(direction_run: Path) -> None:
    ...
    from sprite_studio.effects import reroll
...
def test_curation_post_without_anchors_key_keeps_the_pick(direction_run: Path) -> None:
    ...
    try:
        ...
        # anchors 키가 없는 저장 → 이월
        assert post({"version": 1, "kind": "sprite-studio-curation", "runRevision": revision,
